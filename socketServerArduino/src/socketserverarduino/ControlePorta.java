...
public class ControlePorta {
  ...
  /**
   * @param opcao - Valor String a ser enviado pela porta serial
   */
  public void enviaDadosSt(String opcao){
  ...
  /**
   * @param opcao - Valor INT a ser enviado pela porta serial
   */
    public void enviaDadosInt(int opcao){
